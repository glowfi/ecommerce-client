...
export type SbytermQuery = { __typename?: 'Query', getProductsBySearchTerm: { __typename?: 'ResponseGetallProduct', err?: string | null, data?: Array<{ __typename?: 'Product', id: string, title: string, price: number, brand: string, images: Array<Array<string>>, coverImage: Array<string>, categoryName: string }> | null } };
