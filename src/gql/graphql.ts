...
export type Query = {
  ...
  checkStockByProductId: Scalars['Boolean']['output'];
...
export type QueryCheckStockByProductIdArgs = {
  productID: Scalars['String']['input'];
...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename?: 'LoginResponse', err?: string | null, data?: { __typename?: 'Login', userID: string, email: string, userType: string, accToken: string, refToken: string, profilePic: string, name: string, phoneNumber: string, address: { __typename?: 'Address', streetAddress: string, country: string, countryCode: string, city: string, state: string, zipCode: number } } | null } };
...
export type Product_StockQueryVariables = Exact<{
  productId: Scalars['String']['input'];
  quantity: Scalars['Int']['input'];
}>;


export type Product_StockQuery = { __typename?: 'Query', checkStockByProductId: boolean };
...
export type DeleteaccMutationVariables = Exact<{
  userId: Scalars['String']['input'];
}>;


export type DeleteaccMutation = { __typename?: 'Mutation', deleteUser: { __typename?: 'ResponseUser', err?: string | null, data?: { __typename?: 'User', name: string } | null } };
...
export type SearchTermPaginateQuery = { __typename?: 'Query', getProductsBySearchTermPaginate: { __typename?: 'ResponseGetallProduct', err?: string | null, data?: Array<{ __typename?: 'Product', id: string, title: string, rating: number, price: number, brand: string, categoryName: string, images: Array<Array<string>>, coverImage: Array<string>, stock: number, discountPercent: number }> | null } };
...
export type GetProductByIdQuery = { __typename?: 'Query', getProductById: { __typename?: 'ResponseProduct', err?: string | null, data?: { __typename?: 'Product', id: string, title: string, stock: number, price: number, rating: number, description: string, brand: string, discountPercent: number, categoryName: string, images: Array<Array<string>>, dateCreated: number, dateCreatedHuman: string, coverImage: Array<string>, seller?: { __typename?: 'Seller', email: string, sellerName: string, companyName: string, phoneNumber: string, companyAddress: { __typename?: 'Address', country: string, streetAddress: string, state: string, city: string, zipCode: number, countryCode: string } } | null } | null } };
...
export type PaginateProdQuery = { __typename?: 'Query', getAllProductsPaginate: { __typename?: 'ResponseGetallProduct', err?: string | null, data?: Array<{ __typename?: 'Product', id: string, rating: number, title: string, stock: number, price: number, description: string, brand: string, categoryName: string, images: Array<Array<string>>, dateCreated: number, dateCreatedHuman: string, coverImage: Array<string>, discountPercent: number, totalReviews: number }> | null } };
...
export type Get_Order_By_UseridQuery = { __typename?: 'Query', getOrdersByUserid: { __typename?: 'ResponseGetallOrders', err?: string | null, data?: Array<{ __typename?: 'Orders', id: string, name: string, email: string, phoneNumber: string, paymentBy: string, isPending: boolean, hasFailed: boolean, amount: number, orderedAt: any, address: { __typename?: 'Address', city: string, state: string, country: string, zipCode: number, streetAddress: string }, productsOrdered: Array<{ __typename?: 'Product', title: string, quantity?: number | null, sellerName: string, price: number, discountPercent: number }> }> | null } };
...
export type Search_AtlasQuery = { __typename?: 'Query', getProductsBySearchTermAtlasSearch: { __typename?: 'SearchResponseResult', lastToken?: string | null, err?: string | null, data?: Array<{ __typename?: 'SearchResponse', brand: string, categoryName: string, description: string, coverImage: Array<string>, id: string, price: number, score: number, sellerName: string, title: string, rating: number, stock: number, discountPercent: number }> | null } };
...
export type LogingoogleMutation = { __typename?: 'Mutation', loginGoogle: { __typename?: 'LoginResponse', err?: string | null, data?: { __typename?: 'Login', userID: string, email: string, userType: string, accToken: string, refToken: string, profilePic: string, name: string, phoneNumber: string, address: { __typename?: 'Address', streetAddress: string, country: string, countryCode: string, city: string, state: string, zipCode: number } } | null } };
...
export const Product_StockDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"product_stock"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"productId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"quantity"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"checkStockByProductId"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"productID"},"value":{"kind":"Variable","name":{"kind":"Name","value":"productId"}}},{"kind":"Argument","name":{"kind":"Name","value":"quantity"},"value":{"kind":"Variable","name":{"kind":"Name","value":"quantity"}}}]}]}}]} as unknown as DocumentNode<Product_StockQuery, Product_StockQueryVariables>;
...
export const DeleteaccDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"deleteacc"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"userId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteUser"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"userID"},"value":{"kind":"Variable","name":{"kind":"Name","value":"userId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"data"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}}]}},{"kind":"Field","name":{"kind":"Name","value":"err"}}]}}]}}]} as unknown as DocumentNode<DeleteaccMutation, DeleteaccMutationVariables>;
...
export const LogingoogleDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"logingoogle"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"data"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"InputGoogleLogin"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"loginGoogle"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"data"},"value":{"kind":"Variable","name":{"kind":"Name","value":"data"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"data"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"userID"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"userType"}},{"kind":"Field","name":{"kind":"Name","value":"accToken"}},{"kind":"Field","name":{"kind":"Name","value":"refToken"}},{"kind":"Field","name":{"kind":"Name","value":"profilePic"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"address"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"streetAddress"}},{"kind":"Field","name":{"kind":"Name","value":"country"}},{"kind":"Field","name":{"kind":"Name","value":"countryCode"}},{"kind":"Field","name":{"kind":"Name","value":"city"}},{"kind":"Field","name":{"kind":"Name","value":"state"}},{"kind":"Field","name":{"kind":"Name","value":"zipCode"}}]}},{"kind":"Field","name":{"kind":"Name","value":"phoneNumber"}}]}},{"kind":"Field","name":{"kind":"Name","value":"err"}}]}}]}}]} as unknown as DocumentNode<LogingoogleMutation, LogingoogleMutationVariables>;
