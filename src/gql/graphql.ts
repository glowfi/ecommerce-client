...
export type SearchTermPaginateQuery = { __typename?: 'Query', getProductsBySearchTermPaginate: { __typename?: 'ResponseGetallProduct', err?: string | null, data?: Array<{ __typename?: 'Product', id: string, title: string, rating: number, price: number, brand: string, categoryName: string, images: Array<Array<string>>, coverImage: Array<string>, discountPercent: number }> | null } };
