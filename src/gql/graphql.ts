...
export type Search_AtlasQuery = { __typename?: 'Query', getProductsBySearchTermAtlasSearch: { __typename?: 'SearchResponseResult', lastToken?: string | null, err?: string | null, data?: Array<{ __typename?: 'SearchResponse', brand: string, categoryName: string, description: string, coverImage: Array<string>, id: string, price: number, score: number, sellerName: string, title: string, rating: number, discountPercent: number }> | null } };
