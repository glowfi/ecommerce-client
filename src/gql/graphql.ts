...
export type Create_ReviewMutation = { __typename?: 'Mutation', createReview: { __typename?: 'ResponseReviews', err?: string | null, data?: { __typename?: 'Reviews', id: string, comment: string } | null } };
...
export type SearchTermPaginateQuery = { __typename?: 'Query', getProductsBySearchTermPaginate: { __typename?: 'ResponseGetallProduct', err?: string | null, data?: Array<{ __typename?: 'Product', id: string, title: string, price: number, brand: string, categoryName: string, images: Array<Array<string>>, coverImage: Array<string> }> | null } };
...
export type GetrevuseridQuery = { __typename?: 'Query', getAllReviewsByUserId: { __typename?: 'ResponseGetallReviews', err?: string | null, data?: Array<{ __typename?: 'Reviews', comment: string, userReviewed: { __typename?: 'User', name: string }, productReviewed: { __typename?: 'Product', id: string } }> | null } };
...
export type Get_Reviews_PaginateQuery = { __typename?: 'Query', getReviewsPaginate: { __typename?: 'ResponseGetallReviews', err?: string | null, data?: Array<{ __typename?: 'Reviews', id: string, comment: string, reviewedAt: any, userReviewed: { __typename?: 'User', name: string } }> | null } };
...
export type Search_AtlasQuery = { __typename?: 'Query', getProductsBySearchTermAtlasSearch: { __typename?: 'SearchResponseResult', data: Array<{ __typename?: 'SearchResponse', brand: string, categoryName: string, description: string, coverImage: Array<string>, id: string, price: number, score: number, sellerName: string, title: string }> } };
...
export const Search_AtlasDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"search_atlas"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"term"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getProductsBySearchTermAtlasSearch"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"term"},"value":{"kind":"Variable","name":{"kind":"Name","value":"term"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"data"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"brand"}},{"kind":"Field","name":{"kind":"Name","value":"categoryName"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"coverImage"}},{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"price"}},{"kind":"Field","name":{"kind":"Name","value":"score"}},{"kind":"Field","name":{"kind":"Name","value":"sellerName"}},{"kind":"Field","name":{"kind":"Name","value":"title"}}]}}]}}]}}]} as unknown as DocumentNode<Search_AtlasQuery, Search_AtlasQueryVariables>;
