...
export type SearchTermPaginateQuery = { __typename?: 'Query', getProductsBySearchTermPaginate: { __typename?: 'ResponseGetallProduct', err?: string | null, data?: Array<{ __typename?: 'Product', id: string, title: string, price: number, brand: string, images: Array<Array<string>>, coverImage: Array<string>, category: { __typename?: 'Category', name: string } }> | null } };
...
export type GetProductByIdQuery = { __typename?: 'Query', getProductById: { __typename?: 'ResponseProduct', err?: string | null, data?: { __typename?: 'Product', id: string, title: string, stock: number, price: number, rating: number, description: string, brand: string, images: Array<Array<string>>, dateCreated: number, dateCreatedHuman: string, coverImage: Array<string>, category: { __typename?: 'Category', name: string }, seller: { __typename?: 'Seller', email: string, sellerName: string, companyName: string, phoneNumber: string, companyAddress: { __typename?: 'Address', streetAddress: string, state: string, city: string, zipCode: string, countryCode: string } } } | null } };
