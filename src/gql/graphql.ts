...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename?: 'LoginResponse', err?: string | null, data?: { __typename?: 'Login', userID: string, email: string, userType: string, accToken: string, profilePic: string, name: string, phoneNumber: string, address: { __typename?: 'Address', streetAddress: string, country: string, countryCode: string, city: string, state: string, zipCode: number } } | null } };
