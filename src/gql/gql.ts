...
const documents = {
    ...
    "mutation logingoogle($data: InputGoogleLogin!) {\n  loginGoogle(data: $data) {\n    data {\n      userID\n      email\n      userType\n      accToken\n      refToken\n      profilePic\n      name\n      address {\n        streetAddress\n        country\n        countryCode\n        city\n        state\n        zipCode\n      }\n      phoneNumber\n    }\n    err\n  }\n}": types.LogingoogleDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation logingoogle($data: InputGoogleLogin!) {\n  loginGoogle(data: $data) {\n    data {\n      userID\n      email\n      userType\n      accToken\n      refToken\n      profilePic\n      name\n      address {\n        streetAddress\n        country\n        countryCode\n        city\n        state\n        zipCode\n      }\n      phoneNumber\n    }\n    err\n  }\n}"): (typeof documents)["mutation logingoogle($data: InputGoogleLogin!) {\n  loginGoogle(data: $data) {\n    data {\n      userID\n      email\n      userType\n      accToken\n      refToken\n      profilePic\n      name\n      address {\n        streetAddress\n        country\n        countryCode\n        city\n        state\n        zipCode\n      }\n      phoneNumber\n    }\n    err\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
